...
$templateParameterObject = @{
    ...
    'dcepointname' = 'guardrailsdce'
    'dcrrulename' = 'collectguardrailslogs'
...
$dceEndpoint=$output.Outputs.dceEnpoint.Value
$dcrImmutableId=$output.Outputs.dcrImmutableId.Value
...
$streamName = "Custom-GuardrailsCompliance_CL" #name of the stream in the DCR that represents the destination table
...
ingest-data -dceurl $dceEndpoint -dcrImmutableId $dcrImmutableId -streamName $streamName -data $staticData
# $body = $staticData;
